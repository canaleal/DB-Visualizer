        ...
        <>
            <Modal isOpen={isModalOpen} handleClose={handleCloseModal}>
                ...
                <div className="flex flex-col  text-black p-4">
                    <p className="font-bold text-2xl">Reset_Editor</p>
                ...
                <div className="flex flex-row justify-between gap-2 mt-2 bg-gray-100 px-4 py-4 rounded-b-md">
                    <button title="Reset Text Editor" className={`bg-indigo-900 hover:bg-indigo-800 p-2 rounded-md text-white `} onClick={() => setIsModalOpen(false)}>
                        Do not Reset
                    </button>

                    <button title="Reset Text Editor" className={`flex gap-1 bg-zinc-900 hover:bg-zinc-800 p-2  rounded-md text-white `} onClick={() => { handleReset(); handleCloseModal(); }}>
